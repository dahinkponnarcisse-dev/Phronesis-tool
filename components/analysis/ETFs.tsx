...
const ETFs: React.FC = () => {
  ...
  const generatePrompt = () => {
    return `Provide a detailed analysis of the ETF with ticker ${ticker}. Include its investment strategy, top 10 holdings, expense ratio, and a summary of its recent performance. Also, mention its primary sector exposures and potential risks for an investor. Format as simple text. Do not use markdown.`;
  };
  ...
  return (
    <Card title="AI-Powered ETF Analysis">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-4">
          <h4 className="text-lg font-medium">ETF Profile</h4>
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
            Get a comprehensive overview of any ETF, including its strategy, holdings, and performance.
          </p>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">ETF Ticker</label>
        ...
        <div className="lg:col-span-2">
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border dark:border-gray-700 min-h-[300px]">
                {isLoading ? (
                    ...
                    <p className="text-text-secondary dark:text-dark-text-secondary whitespace-pre-wrap">{analysis || 'Enter an ETF ticker and click "Generate Analysis" to see the results.'}</p>
                )}
            </div>
        </div>
      </div>
